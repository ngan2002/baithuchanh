...
class Main {
    ...
    public static void main(String[] args) {
        ...
        if (D == 0) {
            ...
            double x = Dx / D ;
            double y = Dy / D ;
            System.out.println("Phuong trinh co nghiem la: "+ "x = " + x + " và y = " + y);
        }
    }
